    ...
    def forward(self, x, use_qiskit=False):
        ...
        if use_qiskit:
            ...
            for k in range(bsz):
                ...
                state = x[k]
                block1 = torch.stack((state[0], state[4], state[8], state[12]))
                block2 = torch.stack((state[1], state[5], state[9], state[13]))
                block3 = torch.stack((state[2], state[6], state[10], state[14]))
                block4 = torch.stack((state[3], state[7], state[11], state[15]))
            ...
            for i, t in enumerate(out):
                ...
                block1 = torch.stack((t[0], t[4], t[8], t[12]))
                block2 = torch.stack((t[1], t[5], t[9], t[13]))
                block3 = torch.stack((t[2], t[6], t[10], t[14]))
                block4 = torch.stack((t[3], t[7], t[11], t[15]))

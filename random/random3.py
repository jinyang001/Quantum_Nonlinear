    ...
    def forward(self, x, use_qiskit=False):
        ...
        if use_qiskit:
            ...
            for k in range(bsz):
                ...
                state = x[k]
                block1 = torch.stack((state[0], state[1], state[2], state[3],state[4], state[5], state[6], state[7]))

                block2 = torch.stack((state[8], state[9], state[10], state[11],state[12], state[13], state[14], state[15]))
            ...
            for i, t in enumerate(out):
                ...
                block1 = torch.stack((t[0], t[1], t[2], t[3], t[4], t[5], t[6], t[7]))
...
def main():
    ...
    try:
        ...
        processor_real_qc = QiskitProcessor(use_real_qc=True,
                                            ...
                                            initial_layout=[14, 16, 19, 22, 25, 26],
                                            hub='ibm-q-lanl',
                                            group='lanl',

...
phi = np.concatenate((np.array(np.random.uniform(pi / 2, pi, 30)).T,np.array(np.random.uniform(3*pi / 2, 2*pi, 30)).T), axis=0)
theta2 = np.concatenate((np.array(np.random.uniform(pi / 2, pi, 30)).T,np.array(np.random.uniform(0, pi / 2, 30)).T), axis=0)
phi2 = np.concatenate((np.array(np.random.uniform(0, pi / 2, 30)).T,np.array(np.random.uniform(pi, 3*pi / 2, 30)).T), axis=0)

...
class QFCModel(tq.QuantumModule):
    class QLayer(tq.QuantumModule):
        ...
        def forward(self, q_device: tq.QuantumDevice):
            ...
            # self.ry3(self.q_device, wires=0)
            # self.rz3(self.q_device, wires=0)
            # self.crx3(self.q_device, wires=[1, 2])
            # self.crx5(self.q_device, wires=[2, 3])
            # self.crx4(self.q_device, wires=[3, 0])

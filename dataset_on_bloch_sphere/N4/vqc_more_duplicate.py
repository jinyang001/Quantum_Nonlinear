...
class QFCModel(tq.QuantumModule):
    class QLayer(tq.QuantumModule):
        ...
        def forward(self, q_device: tq.QuantumDevice):
            ...
            for r in range(3):
                ...
                crx_index += 1
                getattr(self, 'crx' + str(crx_index))(self.q_device, wires=[2, 1])
                crx_index += 1
                getattr(self, 'crx' + str(crx_index))(self.q_device, wires=[1, 0])
                crx_index += 1
    ...
    def __init__(self):
        ...
        self.encoder = tq.GeneralEncoder(
            tq.encoder_op_list_name_dict['3x1_u3u3'])
